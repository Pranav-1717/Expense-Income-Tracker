...
const renderStackedBarChart2 = (data, labels, categories) => {
    ...
    new Chart(ctx, {
        ...
        options: {
            ...
            plugins: {
                title: {
                    display: true,
                    text: 'Monthly Category-wise Income'
                }
            }
        }
    });
...
//     fetch("/income_monthly_category_summary/")
//         .then((res) => res.json())
//         .then((results) => {
...
const getMonthlyCategoryChartData = () => {
    fetch("/income_monthly_category_summary/")
        ...
        .then((results) => {
            ...
            renderStackedBarChart2(monthlyData, labels, Array.from(categories));
        })
        .catch((error) => {
            console.error('Error fetching data:', error);
        });
